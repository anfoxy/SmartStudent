...
public class QuestionAddRecycler extends RecyclerView.Adapter<QuestionAddRecycler.ViewHolder> {
    ...
    public QuestionAddRecycler(Context context, ArrayList<Question> questions, OnItemClickListener onItemClickListener) {
