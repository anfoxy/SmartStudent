...
public class QuestionGameAddRecycler extends RecyclerView.Adapter<QuestionGameAddRecycler.ViewHolder> {
    ...
    public QuestionGameAddRecycler(Context context, ArrayList<GameSubjects> questions, OnItemClickListener onItemClickListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_question, parent, false);
