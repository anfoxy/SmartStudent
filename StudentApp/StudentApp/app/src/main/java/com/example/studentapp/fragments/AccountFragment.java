...
//                    user.trueAch(1);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(MainActivity.myDBManager.tr_From_DB_Profile()==0) {
            AlertDialog.Builder builder
                    = new AlertDialog.Builder(getContext());
            ...
            text.setText("Здесь ты сможешь узнать всю необходимую информацию о себе, изменить пароль и узнать какие именно достижения были выполнены");
            ...
            dialog.show();
            MainActivity.myDBManager.update_TRAINING(1, 5);
        }
